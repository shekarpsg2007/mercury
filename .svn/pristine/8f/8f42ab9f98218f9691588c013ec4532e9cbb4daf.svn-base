...
class PatientdetailDeceased(config: Map[String,String]) extends EntitySource(config: Map[String,String]) {
  ...
  mapExceptions = Map(
    ("H667594_HL7", "LOCALVALUE") -> literal("DeathDatePresent"),
    ("H328218_HL7_Genesis", "LOCALVALUE") -> mapFrom("PID_F30_C1", prefix="7135."),
    ("H328218_HL7_UIHC","LOCALVALUE") -> mapFrom("PID_F30_C1", prefix="7133.")
  )
