...
class PatientdetailEthnicity(config: Map[String,String]) extends EntitySource(config: Map[String,String]) {
  ...
  columnSelect = Map(
    "temptable" -> List("PATIENTID","PID_F7_C1","PID_F29_C1","PID_F30_C1","PID_F22_C1","PID_F9_C2","PID_F5_C2"
      ...
      ,"PID_F17_C2","MSH_F7_C1","MSH_F9_C1","MSH_F11_C1","PV1_F44_C1","PID_F22_C2","LASTUPDATEDATE")
  )
  ...
  mapExceptions = Map(
    ("H101623_HL7", "LOCALVALUE") -> mapFrom("PID_F10_C1"),
    ("H171267_HL7", "LOCALVALUE") -> cascadeFrom(Seq("PID_F22_C1", "PID_F10_C1"), prefix = "7708."),
    ("H171267_HL7_GE_IDX", "LOCALVALUE") -> cascadeFrom(Seq("PID_F22_C1", "PID_F10_C1")),
    ("H328218_HL7_Genesis", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7135."),
    ("H328218_HL7_UIHC", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7133."),
    ("H328218_HL7_GRHS", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7136."),
    ("H542284_HL7_ATH", "LOCALVALUE") -> cascadeFrom(Seq("PID_F22_C1", "PID_F10_C1"), prefix = "6964."),
    ("H704847_HL7", "LOCALVALUE") -> mapFrom("PID_F22_C2"),
    ("H704847_HL7_CCD", "LOCALVALUE") -> cascadeFrom(Seq("PID_F22_C2", "PID_F22_C1"),nullIf=Seq("\"\"")), //TODO confirm the syntax
    ("H704847_HL7_OCIE", "LOCALVALUE") -> cascadeFrom(Seq("PID_F22_C2", "PID_F22_C1"),nullIf=Seq("\"\"")),
    ("H908583_HL7", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "1481."),
    ("H451171_HL7_MDT", "LOCALVALUE") -> mapFrom("PID_F10_C1"),
    ("H908583_HL7", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "1481."),
    ("H984216_HL7_CERNER_FLJAC", "LOCALVALUE") -> cascadeFrom(Seq("PID_F22_C1", "PID_F10_C1"), prefix = "7396."),
    ("H984216_HL7_CERNER_TNNAS", "LOCALVALUE") -> cascadeFrom(Seq("PID_F22_C1", "PID_F10_C1"), prefix = "7397."),
    ("H984216_HL7_CERNER_WIMIL", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7398."),
    //TODO H984216_HL7_CN_WIAPP LOCALVALUE. USE HL7_SEGMENT_Z TABLE.
    ("H984216_HL7_INVIS_ALMOB", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7401."),
    ("H984216_HL7_INVIS_INEVA", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7402."),
    ("H984216_HL7_MCK_ALBIR", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7403."),
    ("H984216_HL7_MS4_FLPEN", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7404."),
    ("H984216_HL7_SOAR_ININD", "LOCALVALUE") -> mapFrom("PID_F22_C1", prefix = "7405.")
  )
