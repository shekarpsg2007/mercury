...
/**
  ...
  */
class RxorderPrescriptionserx(config: Map[String, String]) extends EntitySource(config: Map[String, String]) {
    ...
    tables = List("as_erx/*",
        "dict.as_zc_medication_de", "dict.shelf_manifest_entry_wclsid")
    ...
    columnSelect = Map(
        ...
        "dict.as_zc_medication_de" -> List("GPI_TC3", "NDC", "ROUTEOFADMINDE", "ID", "FILEID"),
        "dict.shelf_manifest_entry_wclsid" -> List("GROUPID", "CLIENT_DATA_SRC_ID", "FILE_ID")
    )


    join = (dfs: Map[String, DataFrame])  => {
        var sme = dfs("dict.shelf_manifest_entry_wclsid").withColumnRenamed("GROUPID","GRPID1").withColumnRenamed("CLIENT_DATA_SRC_ID","CLSID")
        var erx = dfs("as_erx/*").withColumnRenamed("FILEID", "FILE_ID")
        var as_zc_medication_de = dfs("dict.as_zc_medication_de").withColumnRenamed("FILEID", "FILE_ID")
