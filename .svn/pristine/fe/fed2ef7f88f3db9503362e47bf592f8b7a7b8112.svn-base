...
/**
  ...
  */
class PatientdetailReligion(config: Map[String, String]) extends EntitySource(config: Map[String, String]) {
  ...
  map = Map(
    ...
    "PATIENTDETAILTYPE" -> literal("RELIGION"),
    "PATDETAIL_TIMESTAMP" -> mapFrom("UPDATE_DATE"), //TODO : As per ETL get max(MSH_F7_C1)
    "LOCALVALUE" -> cascadeFrom(Seq("PID_F17_C2", "PID_F17_C1"))
  )
