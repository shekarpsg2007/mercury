...
class PatientdetailMaritalstatus(config: Map[String, String]) extends EntitySource(config: Map[String, String]) {
  ...
  columnSelect = Map(
    "temptable" -> List("PATIENTID","PID_F7_C1","PID_F29_C1","PID_F30_C1","PID_F22_C1","PID_F9_C2","PID_F5_C2"
      ...
      ,"PID_F17_C2","MSH_F7_C1","MSH_F9_C1","MSH_F11_C1","PV1_F44_C1","PID_F16_C2","LASTUPDATEDATE")
  )
  ...
  map = Map(
    ...
    "LOCALVALUE" -> mapFrom("PID_F16_C1", nullIf=Seq("\"\"")) //TODO nullif(PID_F16_C1, '""')
  )
  ...
  mapExceptions = Map(
    ("H328218_HL7_Genesis", "LOCALVALUE") -> mapFrom("PID_F16_C1", prefix="7135."),
    ("H328218_HL7_UIHC", "LOCALVALUE") -> mapFrom("PID_F16_C1", prefix="7133."),
    ("H704847_HL7", "LOCALVALUE") -> mapFrom("PID_F16_C2"),
    ("H704847_HL7_CCD", "LOCALVALUE") -> cascadeFrom(Seq("PID_F16_C2", "PID_F16_C1"),nullIf=Seq("\"\"")),
    ("H704847_HL7_OCIE", "LOCALVALUE") -> cascadeFrom(Seq("PID_F16_C2", "PID_F16_C1"),nullIf=Seq("\"\""))
  )
