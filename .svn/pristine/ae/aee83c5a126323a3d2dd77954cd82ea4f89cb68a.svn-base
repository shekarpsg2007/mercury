package com.humedica.mercury.etl.backend.procedure

/**
  * Created by cdivakaran on 8/27/18.
  */
...
class ProcedureBackend(config: Map[String,String]) extends EntitySource(config: Map[String,String])  {
  //override def transformModel: String = "PROC_BACKEND"
  tables = List("Procedure", "cdr.ref_cpt4", "cdr.ref_hcpcs",
    "cdr.ref_icd9_px","cdr.ref_icd0_px", "cdr.ref_ub04_rev_codes", "cdr.PATIENT_MPI")
