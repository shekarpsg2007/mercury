...
class PatientdetailMiddlename(config: Map[String, String]) extends EntitySource(config: Map[String, String]) {
  ...
  columnSelect = Map(
    "temptable" -> List("PATIENTID","PID_F7_C1","PID_F29_C1","PID_F30_C1","PID_F22_C1","PID_F9_C2","PID_F5_C2"
      ...
      ,"PID_F17_C2","MSH_F7_C1","MSH_F9_C1","MSH_F11_C1","PV1_F44_C1","LASTUPDATEDATE","PID_F5_C3")
  )
  ...
  map = Map(
    ...
    "LOCALVALUE" -> mapFrom("PID_F5_C3",nullIf=Seq("\"\""))
  )
  ...
  mapExceptions = Map(
    ...
    ("H524284_HL7_ATH", "LOCALVALUE") -> mapFrom("PID_F15_C1", nullIf=Seq("\"\""))
  )
