...
class PatientdetailLanguage(config: Map[String,String]) extends EntitySource(config: Map[String,String]) {
  ...
  columnSelect = Map(
    "temptable" -> List("PATIENTID","PID_F7_C1","PID_F29_C1","PID_F30_C1","PID_F22_C1","PID_F9_C2","PID_F5_C2"
      ,"PID_F8_C1","PID_F15_C1","PID_F15_C2","PID_F9_C1","PID_F5_C1","PID_F16_C1","PID_F3_C1","PID_F10_C1","PID_F17_C1"
  ...
  map = Map(
    ...
    "LOCALVALUE" -> mapFrom("PID_F15_C1", nullIf=Seq("\"\"")) //replace(Pid_F5_C3,'""','')
  )
  ...
  mapExceptions = Map(
    ("H285893_HL7", "LOCALVALUE") -> mapFrom(null),
    ("H328218_HL7_Genesis", "LOCALVALUE") -> mapFrom("PID_F15_C1", prefix = "7135."),
    ("H328218_HL7_UIHC", "LOCALVALUE") -> mapFrom("PID_F15_C1", prefix = "7133."),
    ("H328218_HL7_GRHS", "LOCALVALUE") -> mapFrom("PID_F15_C1", prefix = "7136."),
    ("H524284_HL7_ATH", "LOCALVALUE") -> mapFrom("PID_F15_C1", nullIf=Seq("\"\""), prefix = "6964." ),
    ("H704847_HL7", "LOCALVALUE") -> mapFrom("PID_F15_C2"),
    ("H704847_HL7_CCD", "LOCALVALUE") -> cascadeFrom(Seq("PID_F15_C2", "PID_F15_C1"),nullIf=Seq("\"\"")),
    ("H704847_HL7_OCIE", "LOCALVALUE") -> cascadeFrom(Seq("PID_F15_C2", "PID_F15_C1"),nullIf=Seq("\"\"")),
    ("H984216_HL7_CERNER_FLJAC", "LOCALVALUE") -> mapFrom("PID_F15_C1", prefix = "7396."),
    ("H984216_HL7_CERNER_TNNAS", "LOCALVALUE") -> mapFrom("PID_F15_C1", prefix = "7397."),
    ("H984216_HL7_CERNER_WIMIL", "LOCALVALUE") -> mapFrom("PID_F15_C1", prefix = "7398.")
