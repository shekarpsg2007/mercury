...
*/
  ...
  columns=List("CLIENT_DS_ID", "MPI", "SOURCE", "ASSESSMENT_DTM", "ASSESSMENT_TYPE", "TEXT_VALUE", "NUMERIC_VALUE", "QUALITATIVE_VALUE")
/*
<<<<<<< .mine
  beforeJoin = Map(
...
*/
  ...
  map = Map(
    ...
    "ASSESSMENT_TYPE" -> mapFrom("MAPPEDCODE"),
    "ASSESSMENT_DTM" -> cascadeFrom(Seq("DATECOLLECTED", "DATEAVAILABLE")),
    "TEXT_VALUE" -> mapFrom("LOCALRESULT"),
