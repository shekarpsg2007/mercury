...
class MedicalclaimMedicalclaim(config: Map[String,String]) extends EntitySource(config: Map[String,String]) {

  tables = List("medicalclaim.medical_claim", "diagnosis", "place_of_service", "drg", "facility_claim_std_cost", "physician_claim_std_cost",
  ...
  columnSelect = Map(
    "medicalclaim.medical_claim" -> List("ADJUSTED_HCCC_CODE", "ADJUSTED_CLAIM_IND", "AMT_COB_SAVINGS", "AMT_COINSURANCE", "AMT_COPAY", "AMT_DEDUCTIBLE",
  ...
  join = (dfs: Map[String, DataFrame]) => {
    ...
    println("FILE ===> "+"medicalclaim.medical_claim")
    ...
    var mc = dfs("medicalclaim.medical_claim")
    mc
